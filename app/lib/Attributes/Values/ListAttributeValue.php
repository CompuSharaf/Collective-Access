...
class ListAttributeValue extends AuthorityAttributeValue implements IAttributeValue {
	...
	public function htmlFormElement($pa_element_info, $pa_options=null) {
		...
		if (isset($pa_options['nullOption']) && strlen($pa_options['nullOption'])) {
			...
			$vb_null_option = !$vb_require_value ? ($pa_element_info['settings']['nullOptionText'] ? $pa_element_info['settings']['nullOptionText'] : _t('')) : null;
		}

#  			############ Ahmed Edited here this is the main correction #######		
#		{
#			$vb_null_option = !$vb_require_value ? ($pa_element_info['settings']['nullOptionText'] ?  
# $pa_element_info['settings']['nullOptionText'] : _t('Not set')) : null;
#		}
